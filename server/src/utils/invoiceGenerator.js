...
export const generateLeadInvoicePDF = async (leadData, paymentData, outputPath) => {
...
function drawFooter(doc, brownColor) {
...
export const generateInvoicePDF = async (invoiceData, entityData, outputPath) => {
    return new Promise((resolve, reject) => {
        try {
